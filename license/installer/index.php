                    ...
                    <div class="login">
                        <div class="center-box">
                                            ...
                                            if($activate_response['status'] != true){ ?>
                                                <form action="index.php?step=0" method="POST">
                                                    ...
                                                    <div class="field">
                                                      ...
                                                      <div class="control">
                                                        <input class="input" type="text" placeholder="enter your name/envato username" name="client" value="nulled" required>
                                                      </div>
                                                    </div>
                                                    <div class="mt-5">
                            ...
                            <div class="content has-text-centered mt-5">
                                <p>© <?php echo date('Y'); ?> Copyright TheBarber by <a href="https://saasmonks.in" target="/">SaaSMonks </a></p><br>
                            </div>
                        </div>
                    </div>
                </div> 
