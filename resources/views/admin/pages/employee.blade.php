        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    <span class="h3">{{__('Staff table')}}</span>
                    <button class="btn btn-primary addbtn float-right p-2"><a class="color-white" href="{{url('admin/staff/create')}}"><i class="fas fa-plus mr-1"></i>{{__('Add New')}}</a></button>
                </div>
                <!-- table -->
                <div class="table-responsive">
                    ...
                    <tbody class="list">
                                ...
                                <tr>
                                    ...
                                    <td class="table-actions">
                                        @php
                                            $base_url = url('/');
                                        @endphp
                                        <a href="{{url('admin/staff/'.$emp->emp_id)}}" class="table-action text-warning" data-toggle="tooltip" data-original-title="{{__('View staff')}}">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{url('admin/staff/edit/'.$emp->emp_id)}}" class="table-action text-info" data-toggle="tooltip" data-original-title="{{__('Edit staff')}}">
                                            <i class="fas fa-user-edit"></i>
                                        </a>
                                        <button class="btn-white btn shadow-none p-0 m-0 table-action text-danger bg-white" onclick="deleteData('admin/staff',{{$emp->emp_id}},'{{$base_url}}')" data-toggle="tooltip" data-original-title="{{__('Delete staff')}}">
                        ...
                        @else
                            <tr>
                                <th colspan="10" class="text-center">{{__('No staffs')}}</th>
                            </tr>
                        @endif
                    </tbody>
                </table>
