        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0 text-center">
                    <span class="h3">{{__('Add Staff')}}</span>
                </div>
                <div class="mx-4 ">
                    <div class="nav-wrapper">
                        <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-icons-text-1-tab" data-toggle="tab" href="#tabs-icons-text-1" role="tab" aria-controls="tabs-icons-text-1" aria-selected="true"><i class="ni ni-single-02 mr-2"></i>{{__('Staff')}}</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <form class="form-horizontal form" action="{{url('/admin/staff')}}" method="post" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                            <div class="p-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{old('name')}}" name="name" id="name" class="form-control" placeholder="{{__('Staff Name')}}"  autofocus>
                                                    @error('name')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{old('position')}}" name="position" id="position" class="form-control" placeholder="{{__('Staff Position')}}">
                                                    @error('position')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{old('email')}}" class="form-control" name="email" id="email" placeholder="{{__('Staff Email')}}" >
                                                    @error('email')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                    @enderror
                                                </div>
