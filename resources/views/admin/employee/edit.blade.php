        ...
        <div class="col-xl-8 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal form" action="{{url('/admin/staff/update/'.$emp->emp_id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                                        ...
                                        <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                            <div class="p-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{old('position', $emp->position)}}" name="position" id="position" class="form-control" placeholder="{{__('Staff Position')}}">
                                                    @error('position')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="{{old('email', $emp->email)}}" name="email" id="email" placeholder="{{__('Staff Email')}}">
                                                    @error('email')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                    @enderror
                                                </div>
