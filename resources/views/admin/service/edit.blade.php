                    ...
                    <form class="form-horizontal" id="edit_service_form" action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="my-0">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="{{__('Service Name')}}"  autofocus>
                                <div class="invalid-div "><span class="name"></span></div>
                            </div>
                            <div class="form-group">
                                <label class="form-control-label" for="desc">{{__('Service Description')}}</label>
                                <textarea name="desc" id="desc" cols="30" rows="10" placeholder="{{__('Service Description')}}" class="form-control">{{ old('desc') }}</textarea>
