                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                            ...
                                            {{-- Email --}}
                                            <div class="form-group">
                                                <label for="email" class="form-control-label">{{__('Website Email')}}</label>
                                                <input type="email" class="form-control" value="{{old('email', $salon->email)}}" name="email" id="email" placeholder="{{__('Website email')}}">
                                                @error('email')
                                                    <div class="invalid-div">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{old('facebook', $salon->facebook)}}" name="facebook" id="facebook" placeholder="{{__('Facebook')}}" >
                                                @error('facebook')
                                                    <div class="invalid-div">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{old('instagram', $salon->instagram)}}" name="instagram" id="instagram" placeholder="{{__('Instagram')}}" >
                                                @error('instagram')
                                                    <div class="invalid-div">{{ $message }}</div>
                                                @enderror
                                            </div>
