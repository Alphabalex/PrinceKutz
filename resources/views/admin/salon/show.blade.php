                                    ...
                                    <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mt-1"><span class="font-weight-bold">{{__('Address :')}} </span><span>&numsp;{{$salon->address}}</span></div>
                                                <div class="mt-1"><span class="font-weight-bold">{{__('Email :')}} </span><span>&numsp;{{$salon->email}}</span></div>
                                                <div class="mt-1"><span class="font-weight-bold">{{__('Facebook :')}} </span><span>&numsp;{{$salon->facebook}}</span></div>
                                                <div class="mt-1"><span class="font-weight-bold">{{__('Instagram :')}} </span><span>&numsp;{{$salon->instagram}}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
